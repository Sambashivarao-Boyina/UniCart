...
export default function Product({product}){
    return (
        <div className="w-80 sm:w-96 bg-white flex flex-col border p-2 border-gray-200 bg-red m-2 md:m-4  rounded-lg hover:scale-105 duration-200 shadow-md hover:shadow-xl">
