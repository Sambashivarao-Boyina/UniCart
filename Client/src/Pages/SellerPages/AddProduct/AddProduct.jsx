...
export default function AddProduct(){
    ...
    const {values,errors,touched,isSubmitting,handleChange,handleBlur,resetForm,handleSubmit,setFieldValue}=useFormik({
        initialValues:{
            title:"",
            description:"",
            price:'',
    ...
    return (
        <>
             <div className="breadcrumbs text-sm lg:ml-20 mb-5">
